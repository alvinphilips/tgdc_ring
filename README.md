...
If you know how to make a website but have never made a blog, template based [static site generators](https://jamstack.org/generators/) are popular choices, [Hugo](https://gohugo.io/) is great, although writing your own custom static site generator [is simple](https://github.com/JUB-Yoush/mywebsite). Static pages can be hosted for free on github.


If you've never done any programming but still want to make a site, [neocities](https://neocities.org/) is the most accessible platform to get started with and provides free hosting as well.
